  ...
  <div class="mt-16">
    <form @submit.prevent="handleSubmit">
      <label class="block">
          ...
          <input id="name-field" v-model="state.name.value" type="text" :class="{
            'border-brand-danger': !!state.name.errorMessage
          }" class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded" placeholder="Jone Doe">
          <span id="nome-error" v-if="!!state.name.errorMessage" class="block font-medium text-brand-danger">
      ...
      <label class="block mt-9">
        ...
        <input id="email-field" v-model="state.email.value" type="email" :class="{
          'border-brand-danger': !!state.email.errorMessage
        }" class="block w-full px-4 py-3 mt-1 text-lg bg-gray-100 border-2 border-transparent rounded" placeholder="jane.dae@gmail.com">
      ...
      <label class="block mt-9">
        ...
        <input id="password-field" v-model="state.password.value" type="password" :class="{
